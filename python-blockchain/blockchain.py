...
class Blockchain:
    ...
    def add_transaction(self, recipient, sender, signature, amount=1.0, is_receiving=False):
        ...
        Arguments:
            ...
            :signature: It has the signature of the transactions
        """
        # transaction = {
        #     'sender': sender,
        #     'recipient': recipient,
        ...
        for node in self.__peer_nodes:
            ...
            try:
                ...
                block_transactions = [Transaction(
                    tx['sender'], tx['recipient'], tx['signature'], tx['amount']) for tx in node_chain['transactions']]
                node_chain = [Block(block['index'],
                                    block['previous_hash'], block_transactions, block['proof'],
